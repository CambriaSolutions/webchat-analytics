  ...
  return (
    <>
      ...
      <ComposedChart
        data={data}
        xKey='id'>
        <Bar type="monotone" dataKey="numConversations" fill={lightestColor} name="Total Users" />
        <Bar type="monotone" dataKey="numConversationsWithDuration" fill={darkestColor} name="Engaged Users" />
        <Legend />
